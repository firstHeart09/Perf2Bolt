...
END {
	...
	for(trace in FallthroughLBRs){
        ...
        split(First, arr1, ",")
        split(Second, arr2, ",")
        print "LBREntry First From: " arr1[1] " To: " arr1[2] " Mispred: " arr1[3] >> "perf_temp_branch1.log"
        print "LBREntry Second From: " arr2[1] " To: " arr2[2] " Mispred: " arr2[3] >> "perf_temp_branch1.log"
        print "FTInfo InternCount: " counts[1] " ExternCount: " counts[2] >> "perf_temp_branch1.log"
		# if (counts[1]){
